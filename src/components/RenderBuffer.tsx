...
export const RenderBuffer: React.FC = () => {
  ...
  return (
    <div>
      <h2>Render Buffer</h2>
      <p>
        This tab displays the GPU render buffer output from the Expected Score computation. It
        provides a WebGPU-rendered view of the computed data, demonstrating GPU-accelerated
